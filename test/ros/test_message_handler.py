...
def test_SensorMsgsMsgImageHandler_save(setup_typestore, setup_temp_dir):
    ...
    assert Path(path_img) == tmp_dir / "image" / "1620000000_123456789_sensor_msgs__msg__Image.jpg"
...
def test_GenericMessageHandler_save_json(setup_typestore, setup_temp_dir):
    ...
    assert Path(path_imu) == tmp_dir / "imu" / "1620000000_123456789_sensor_msgs__msg__Imu.json"
